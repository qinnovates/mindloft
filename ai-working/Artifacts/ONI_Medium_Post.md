# There's No Security Model for Brain-Computer Interfaces

Neuralink has implanted its first human patients. Synchron is in FDA trials. Blackrock Neurotech has been in human brains since 2004.

These devices are tested for safety and efficacy. They are not tested against adversarial threats.

I've spent 15 years in cyber threat intelligence. I've watched industries build first and secure later. I don't want to see that happen with technology that interfaces directly with human cognition.
...
I'm publishing an open framework called **ONI (Organic Network Interface)** - a 14-layer model that extends the OSI stack into biological territory.
...
Read the paper. Tell me what's wrong. The biological layers especially need expert review - I'm a security person, not a neuroscientist.

If this framework is useful, it won't be because I got it right. It'll be because the right people helped fix it.
