...
My work ethic comes from watching my father, an autodidactic electrical engineer from China, navigate a world that didn't recognize his brilliance. Despite deep technical knowledge, he had no formal education and immigrated here to work as a dishwasher—all to help pay for his father's woodworking factory, which eventually burned to the ground.
...
That dual perspective — engineer and adversary — is what makes security engineering work. I started on the defensive side, building systems. But I learned quickly that you can't protect what you don't understand from the attacker's perspective. Over time, the line between offense and defense dissolved entirely. The best security architects think like both — probing their own systems like an adversary so they can defend them like an engineer. That convergence is what I bring to neurosecurity.
